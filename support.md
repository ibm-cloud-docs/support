...
In the {{site.data.keyword.cloud_notm}} console, go to **Manage > Billing and usage > Overview > Support costs**. You can view your support plan and relevant cost details:
