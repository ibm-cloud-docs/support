...
On the [Communication history page](/messaging){: external}, you can check the status of all email notifications that are sent to you, and you can verify whether the emails are delivered successfully. You can also view the last 90 days of IBM Cloud email history, which can help you save time by troubleshooting any delivery issues without you having to contact IBM support.

To view your email notification history and check the delivery status of an IBM Cloud email, complete the following steps:

1. In the IBM Cloud console, click the **Notifications** icon ![Notifications icon "Notifications"](../icons/Notification.svg) in the menu bar.
...
Identify which of your devices are affected by the scheduled or ongoing maintenance activity in IBM Cloud.

To obtain a list of devices impacted under the maintenance activity, complete the following steps:

1. Log in to IBM Cloud by using your credentials.
...
You can directly go to the maintenance notification page through [IBM Cloud Notifications](https://cloud.ibm.com/notifications){: external}
{: note}
